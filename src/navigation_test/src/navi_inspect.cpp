...
int main(int argc, char** argv)
{
	//set pose
	//people
	ViewPoint.position.x = 2.12602;//0.860085680301;
	ViewPoint.position.y = 0.0339659;//-2.83426480702;
	ViewPoint.position.z = 0;
	ViewPoint.orientation.x = 0;
	ViewPoint.orientation.y = 0;
	ViewPoint.orientation.z = -0.484121;//0.097098622328;
	ViewPoint.orientation.w = 0.875001;//0.995274764847;

	//living_room
	OutPoint.position.x = 0.0548753;
	OutPoint.position.y = 1.07494;
	OutPoint.position.z = 0;
	OutPoint.orientation.x = 0;
	OutPoint.orientation.y = 0;
	OutPoint.orientation.z = 0.863549;
	OutPoint.orientation.w = 0.504265;
