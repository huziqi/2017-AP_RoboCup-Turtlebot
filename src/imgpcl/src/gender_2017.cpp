...
{  
    ...
    {   
       ...
       // Rect face_id = faces[i];
        ...
        model->load("/home/kamerider/catkin_ws/src/imgpcl/eigenfacepca.yml");
        string box_text;
        box_text = format( "" );
    ...
    imwrite("/home/kamerider/catkin_ws/src/imgpcl/gender_detect.jpg",frame);//保存图片
        if(female_num == 0)
...
{    
    ...
    {   
        ...
        imwrite("/home/kamerider/catkin_ws/src/imgpcl/capimg.jpg",capimg);//保存图片  
        ...
        /// 测试图像 - 尺寸必须能被 2^{n} 整除
        src = imread( "/home/kamerider/catkin_ws/src/imgpcl/capimg.jpg" );
        if( !src.data )
        {
...
{    
    ...
    image_transport::Subscriber sub = it.subscribe("kinect/rgb/image_raw", 1, imageCallback);    
