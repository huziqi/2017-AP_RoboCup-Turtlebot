...
void image_process(Mat inImg)    
{
	...
	{
		tour-=6.28;
		img2voiceP.data=" please get away from me ";
    ...
    {   
        ...
        img2voiceP.data = "I am reaching the person";
        image2voice_Pub.publish(img2voiceP);
        ...
        if(abs(pos_x - 320) < 80 && pos_y < 140)
	    {
            ...
            image2voice_Pub.publish(img2voiceP); 
            iffind_personP.data = "found_person";
            iffind_person_Pub.publish(iffind_personP);                       		    state = 2;		
	    }
    }
	imwrite("/home/kamerider/catkin_ws/src/imgpcl/person.jpg",inImg);//保存图片    
